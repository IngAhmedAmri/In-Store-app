...
class _SignUpInstaScreenState extends State<SignUpInstaScreen> {
  ...
  Future<void> _registerAccountWithImage() async {
    if (_formKey.currentState!.validate()) {
      String username = _nomInstagrammeurController.text;
      ...
      _signUpController.registerAccountWithJson(payload, _image).then((_) {
        print('Compte créé avec succès pour $username');
      }).catchError((error) {
