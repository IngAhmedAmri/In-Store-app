...
class AddProductScreen extends StatefulWidget {
  ...
  AddProductScreen({required this.categories, required this.brands});
  ...
  Future<void> _addNewBrand() async {
    String? newBrandName = await showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Ajouter une nouvelle marque'),
          content: TextField(
            controller: brandNameController,
            decoration: InputDecoration(hintText: 'Nom de la marque'),
          ),
          actions: <Widget>[
            TextButton(
              child: Text('Annuler'),
